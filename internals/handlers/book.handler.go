...
func (b *BookHandler) DeleteBook(ctx *gin.Context) {
	...
	// Konversi ID buku dari string ke integer
	id, _ := strconv.Atoi(ctx.Param("id"))
	...
	// Jika berhasil, kembalikan respons sukses. Kirim response dalam bentuk json, gin.H untuk membuat map dengan key string & vlaue any
	ctx.JSON(http.StatusOK, gin.H{
